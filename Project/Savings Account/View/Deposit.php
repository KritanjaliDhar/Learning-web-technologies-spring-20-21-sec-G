...
<html>
   ...
   <h1>DEPOSIT FORM</h1>
   <table>
      <form name="DepoForm" method="POST" action="Deposit.php" onsubmit="return validateForm()" >
         <tr>
		   <td>First name: </td>
...
error_reporting(0);
		...
		{if (isset($_POST['submit'])){
		  $q="INSERT INTO transaction (first_name,last_name,company_name,salary) VALUES ('$firstname','$lastname','$companyname','$depositamount')";
